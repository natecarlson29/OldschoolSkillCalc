        ...
        <main> 
            ...
            <aside>
                <table>
                    ...
                    <?php foreach($_SESSION['user_accounts'] as $account)
                        {echo '<tr><th> <a href=index.php?action=loadAccountFromList&accountToLoad=' . $account . '>' . $account . '</a></th></form><form action=\'index.php?action=deleteAccount\' method=\'post\'><th><input type=\'submit\' value=\'Delete\'><input type=\'hidden\' id=\'accNameToDel\' name=\'accNameToDel\' value=\'' . $account . '\'></form></th></tr>';} ?>
                </table>
            </aside>
        </main>
